...
set LOG_FILE=%LOG_DIR%\daily_update_%TIMESTAMP%.log
...
echo Daily market foundation update started. Log: %LOG_FILE%
"%PYTHON_EXE%" scripts\retry_daily_market_foundation_update.py --official-only --time-window-start 15:00 --time-window-end 23:59 --max-retries 18 --retry-delay-seconds 1800 --log-file "%LOG_FILE%" --report-file "%REPORT_FILE%" %*
